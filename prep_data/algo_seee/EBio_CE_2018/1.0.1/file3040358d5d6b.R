...
options(warn = -1)
File_station <- "file304072a15f26.txt"
File_ibd     <- "file304033197a6e.txt"
File_ibmr    <- "file30406bd24eb1.txt"
File_mib     <- "file304019625614.txt"
File_ipr     <- "file3040259d5259.txt"
